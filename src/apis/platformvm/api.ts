...
import { Defaults, PlatformChainID, ONEAXC } from "../../utils/constants"
...
export class PlatformVMAPI extends JRPCAPI {
  ...
  refreshBlockchainID = (blockchainID: string = undefined): boolean => {
    ...
    if (
      ...
      this.blockchainID = PlatformChainID //default to CoreChain
      return true
    }
