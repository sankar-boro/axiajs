...
describe("Transactions", (): void => {
  ...
  beforeAll(async (): Promise<void> => {
    ...
    api = new AVMAPI(axia, "/ext/bc/avm", bID)
    ...
    axcAssetID = await result
  })

  beforeEach((): void => {
    set = new UTXOSet()
    keymgr1 = new KeyChain(axia.getHRP(), alias)
